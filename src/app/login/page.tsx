        ...
        <main className="min-h-screen flex items-center justify-center bg-slate-50 p-6">
            <div className="w-full max-w-md bg-slate-900 rounded-[2.5rem] shadow-2xl p-10 border border-slate-800 slide-up">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-3xl font-black text-white tracking-tighter italic">WELCOME BACK</h1>
                    <p className="text-slate-400 text-sm mt-2 font-medium">Access your global investment console.</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    <div>
                        <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest block mb-2 px-1">Security Key</label>
                        <input
                            type="password"
                            required
                            className="w-full bg-slate-800 border border-slate-700 rounded-2xl px-5 py-4 text-white text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all"
