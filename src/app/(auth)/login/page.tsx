        ...
        <main className="min-h-screen flex items-center justify-center bg-white p-6">
            <div className="w-full max-w-md bg-slate-950 rounded-[2.5rem] shadow-2xl p-10 border border-slate-900 slide-up">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-3xl font-black text-white tracking-tighter italic uppercase">Login</h1>
                    <p className="text-slate-400 text-sm mt-2 font-medium">Access the Command Center.</p>
                </div>
                ...
                <div className="mt-10 text-center">
                    <p className="text-slate-500 text-sm font-medium">
                        ...
                        <Link href="/register" className="text-[#003DA5] font-bold hover:underline">
                            Register here
                        </Link>
                    </p>
                </div>
